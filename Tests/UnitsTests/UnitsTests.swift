...
final class UnitsTests: XCTestCase {
    func testMultiply() throws {
        ...
        XCTAssertEqual(
            length1.multiply(by: length2).value,
            25
        )
        XCTAssertEqual(
            length1.multiply(by: length2).unit.dimension,
            [.Length: 2]
        )
        ...
        XCTAssertEqual(
            force.multiply(by: time).value,
            14
        )
        XCTAssertEqual(
            force.multiply(by: time).unit.dimension,
    ...
    func testDivide() throws {
        ...
        XCTAssertEqual(
            length.divide(by: time).value,
            2
        )
        XCTAssertEqual(
            length.divide(by: time).unit.dimension,
            [.Length: 1, .Time: -1]
        )
    }
}
